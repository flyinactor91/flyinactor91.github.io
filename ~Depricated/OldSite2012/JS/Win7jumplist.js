...
(function( jumplist ) {
	...
	var options = {
		...
		siteName: 'Michael duPont\'s Home', // Site Name
		applicationName: 'Michael duPont\'s Home', // Site Name 
		startURL: '', // Homepage URL 
		shortcutIcon: 'https://buildmypinnedsite.blob.core.windows.net/files/JumpList/634997471494565144/Main-favicon.ico', // Main Site Icon
		tooltip: '',
		...
		staticTasks: [{ name: 'Home',  action: 'flyinactor91.com', icon: 'https://buildmypinnedsite.blob.core.windows.net/files/JumpList/634997471494565144/Task0-favicon.ico', target: 'tab' }],
		
		// Drag and drop site pinning bar		
		prompt: false, // Add a site pinning bar on top of my site pages
		barSiteName: 'Michael duPont\'s Home' // Site name as it should appear on the pinning bar
	};
